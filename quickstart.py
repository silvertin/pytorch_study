...
class PytorchTest:
    ...
    def run(self, epochs: int):
        for t in range(epochs):
            ...
            # tensorboard
            # model save
            # early stopping 가장 근본은 정규화, 과적합을 방지
            # validation loss는 줄어들지 않음, trainset loss는 계속 줄어듬
            # model early stopping ? break
...
if __name__ == '__main__':
    ...
    module = ConvNet()
    # magic number
    pt = PytorchTest(mnist_train, mnist_test, 64, module,
